...
const Mdx = ({
  ...
  <article
    className={cn(
      "prose max-w-full prose-h1:text-5xl prose-h1:font-extrabold prose-h1:tracking-tight prose-h2:mb-3 prose-h2:scroll-m-20 prose-h2:border-b prose-h2:pt-4 prose-h2:text-4xl prose-h2:font-semibold prose-h2:tracking-tight prose-h2:first:mt-0 prose-h2:first:pt-0 prose-h3:text-3xl prose-h4:text-2xl prose-h5:text-xl prose-h6:text-lg prose-code:rounded-md prose-code:bg-muted prose-code:p-1 prose-code:before:hidden prose-code:after:hidden dark:prose-headings:text-primary-foreground dark:prose-p:text-primary-foreground dark:prose-strong:text-primary-foreground dark:prose-code:text-primary dark:prose-li:text-primary-foreground prose-h1:lg:text-6xl",
      className,
    )}
    {...props}
  >
